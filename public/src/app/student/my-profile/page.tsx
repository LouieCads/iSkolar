        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="w-30 h-30 rounded-full overflow-hidden border-4 border-white shadow-lg mb-4">
              <img
                src={mockStudentProfile.profileImage}
                alt={mockStudentProfile.name}
                className="w-full h-full object-cover"
              />
            </div>
            
            {/* Profile Info */}
            <h1 className="text-lg font-bold text-gray-900 mb-2">{mockStudentProfile.name}</h1>
            <p className="text-gray-600 text-sm mb-1">{mockStudentProfile.course}</p>
            <p className="text-gray-600 text-sm mb-3">{mockStudentProfile.yearLevel} • {mockStudentProfile.semester}</p>
            
            {/* Contact Info */}
            <div className="flex items-center gap-6 text-xs text-gray-500">
              <div className="flex items-center gap-1">
                <Mail className="w-4 h-4" />
                <span>{mockStudentProfile.email}</span>
              </div>
              <div className="flex items-center gap-1">
                <Phone className="w-4 h-4" />
                <span>{mockStudentProfile.phone}</span>
              </div>
              <div className="flex items-center gap-1">
                <MapPin className="w-4 h-4" />
                <span>{mockStudentProfile.location}</span>
              </div>
            </div>
          </div>
        </div>
