      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-8 mb-8 border border-blue-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="flex items-start space-x-3">
            ...
            <p className="text-sm text-gray-800">Apply to active scholarships posted by sponsors</p>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-lg">✓</span>
            <p className="text-sm text-gray-800">Receive tuition funding directly through the platform</p>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-lg">✓</span>
            <p className="text-sm text-gray-800">Get matched with scholarships based on your academic profile</p>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-lg">✓</span>
            <p className="text-sm text-gray-800">Track your applications and fund disbursements in one place</p>
          </div>
        </div>
      </div>
